<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:178137:"/* Copyright (C) YOOtheme GmbH, http://www.gnu.org/licenses/gpl.html GNU/GPL */
...
.dropdown-submenu:focus > a {
  ...
  background-image: -moz-linear-gradient(top, #00a8e6, #0095cd);
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#00a8e6), to(#0095cd));
  background-image: -webkit-linear-gradient(top, #00a8e6, #0095cd);
  background-image: -o-linear-gradient(top, #00a8e6, #0095cd);
  background-image: linear-gradient(to bottom, #00a8e6, #0095cd);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff00a8e6', endColorstr='#ff0095cd', GradientType=0);
}
...
.btn-primary {
  ...
  background-image: -moz-linear-gradient(top, #1fa2d6, #359ac4);
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#1fa2d6), to(#359ac4));
  background-image: -webkit-linear-gradient(top, #1fa2d6, #359ac4);
  background-image: -o-linear-gradient(top, #1fa2d6, #359ac4);
  background-image: linear-gradient(to bottom, #1fa2d6, #359ac4);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff1fa2d6', endColorstr='#ff359ac4', GradientType=0);
...
.navbar .btn-navbar {
  ...
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#f2f2f2), to(#e1e1e1));
