...
$this['asset']->addFile('css', 'css:owl.carousel.css'); 
//phone button
$this['asset']->addFile('css', 'css:phone/style.css');
//gal
$this['asset']->addFile('css', 'css:galery/css/base.css'); 
$this['asset']->addFile('css', 'css:galery/css/bottom.css'); 
...
$this['asset']->addFile('js', 'js:addfunc.js');
//owl
$this['asset']->addFile('js', 'js:owl/owl.carousel.min.js');
//gal
$this['asset']->addFile('js', 'js:gal/lib/jquery.jcarousel.min.js');
$this['asset']->addFile('js', 'js:gal/lib/jquery.pikachoose.min.js');
$this['asset']->addFile('js', 'js:gal/lib/jquery.touchwipe.min.js');
