		...
		<a href="<?php echo $link ?>">
			...
			<div class="content">				
				<div class="data">
					...
					<?php IF($this->params->get('show_text',1)==1):?><div class="text"><?php echo $this->entry->getIntroText();?></div><?php ENDIF ?>
					<?php IF($this->params->get('show_imagecount',1)==1):?><hr /><div class="imagecount"><small class="muted"><?php echo JText::_('COM_EVENTGALLERY_EVENTS_LABEL_IMAGECOUNT') ?> <?php echo $this->entry->getFileCount();?></small></div><?php ENDIF ?>				
