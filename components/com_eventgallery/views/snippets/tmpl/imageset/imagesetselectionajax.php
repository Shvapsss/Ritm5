...
<div class="imagetypeselection-container">
    ...
    <div class="well imagetypeselection" style="display:none">
        ...
        <div class="btn-group pull-right">
            ...
            <?PHP ENDIF ?>
            <a title="<?php echo JText::_('COM_EVENTGALLERY_CART_BUTTON_CART_DESCRIPTION') ?>" class="btn btn-default" href="<?php echo JRoute::_('index.php?option=com_eventgallery&view=cart'); ?>"><?php echo JText::_('COM_EVENTGALLERY_CART_BUTTON_CART_LABEL') ?></i></a>
