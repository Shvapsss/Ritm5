...
<script type="text/javascript">
    ...
    {
        if (task == 'watermark.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {
...
<?php endif;?>
        ...
        <img class="thumbnail" id="watermark-preview" src="<?php echo JRoute::_('index.php?option=com_eventgallery&view=watermarkpreview&id='.$this->item->id); ?>">
